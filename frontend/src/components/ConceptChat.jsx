...
export default function ConceptChat() {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-10rem)]">
      <div className="mb-4">
        <h1 className="text-2xl font-bold text-ink">AI Concept Simulator</h1>
        <p className="text-gray-500 text-sm">Ask about AI policy concepts — answers are tailored to Morocco's context.</p>
      </div>
                      ...
                      <div className="flex flex-wrap gap-1.5">
                        {msg.related.map(r => (
                          <button
                            ...
                            className="px-2 py-0.5 text-xs bg-violet-blue-50 text-violet-blue
                                       rounded-full hover:bg-violet-blue-100 transition-colors duration-200"
                          >
                            {r.term}
                          </button>
                        ))}
      ...
      <form onSubmit={handleSubmit} className="flex gap-2">
        ...
        <button
          ...
          className="px-4 py-3 bg-ink text-white rounded-xl hover:bg-ink-800
